...
try:
    ...
    phone = input(gr+"[+] Enter API ID : "+re)
...
for user in users:
    ...
    try:
        ...
        timer = random.randrange(23, 30);
        print(gr + "[+] Waiting for {} sec ...".format(timer))
        time.sleep(timer)
    except PeerFloodError:
        print(
            re + "[!] Getting Flood Errors from Telegram. \n[!] Script is stopping for now. \n[!] Please try again after some time.")
